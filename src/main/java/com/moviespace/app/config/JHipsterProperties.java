...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "moviespace@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "moviespace API";

        private String description = "moviespace API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "moviespace";
