...
angular.module('moviespaceApp', ['LocalStorageModule', 'ngStorage',
    'ngResource', 'ngCookies', 'ngAria', 'ngCacheBuster','ui.slimscroll','ui.select','ui.knob', 'ngFileUpload',/*'ngAnimate',*/
