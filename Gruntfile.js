// Generated on 2016-06-14 using generator-jhipster 2.24.0
'use strict';
var fs = require('fs');
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        wiredep: {
            app: {
                src: ['src/main/webapp/index.tpl.html','src/main/webapp/index.html','src/main/scss/main.scss'],
                exclude: [
        ...
        includeSource: {
            ...
            app: {
                files: {
                    'src/main/webapp/index.html': 'src/main/webapp/index.tpl.html'
                }
            }
        },
        browserSync: {
